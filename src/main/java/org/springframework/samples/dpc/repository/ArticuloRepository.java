...
public interface ArticuloRepository extends CrudRepository<Articulo, Integer> {
	...
	Page<Articulo> articulosEnVentaPorId(@Param("vendedorId") Integer vendedorId, Pageable pageable) throws DataAccessException;
	...
	Page<Articulo> articulosPorGenero(@Param("generosId") List<Integer> generosId, Pageable pageable) throws DataAccessException;
	...
	Page<Articulo> articulosPorGeneroNombre(@Param("generosId") List<Integer> generosId, @Param("nombre") String nombre, Pageable pageable) throws DataAccessException;
