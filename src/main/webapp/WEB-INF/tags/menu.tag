		...
		<div class="navbar-collapse collapse" id="main-navbar">
			<ul class="nav navbar-nav">
				...
				<sec:authorize access="hasAuthority('vendedor')">
					<petclinic:menuItem active="${name eq 'articulos'}" url="/vendedores/articulosEnVenta" title="Art�culos en venta">
						<span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
						<span>Art�culos en venta</span>
					</petclinic:menuItem>
					<petclinic:menuItem active="${name eq 'crearSolicitud'}" url="/solicitudes/new" title="Creaci�n solicitudes">
						<span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
